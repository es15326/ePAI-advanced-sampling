...
def parse_prediction_new_row(pred_pancreas_tumor, probabilities_final, properties_dict, output_file_truncated, dataset_json_dict_or_file):
    ...
    PDAC, PDAC_component_count, PDAC_voxel_size, PDAC_volume_size, PDAC_largest_logit = get_shared_properties(pred_pancreas_tumor, probabilities_final, spcaing_for_volume_size, dataset_json_dict_or_file["labels"]["pancreatic_lesion"])
    cyst, cyst_component_count, cyst_voxel_size, cyst_volume_size, cyst_largest_logit = get_shared_properties(pred_pancreas_tumor, probabilities_final, spcaing_for_volume_size, dataset_json_dict_or_file["labels"]["pancreatic_lesion"])
    PNET, PNET_component_count, PNET_voxel_size, PNET_volume_size, PNET_largest_logit = get_shared_properties(pred_pancreas_tumor, probabilities_final, spcaing_for_volume_size, dataset_json_dict_or_file["labels"]["pancreatic_lesion"])
...
def export_prediction_from_logits(predicted_array_or_file: Union[np.ndarray, torch.Tensor], properties_dict: dict,
    ...
    if save_probabilities:
        ...
        pancreas_and_tumor_labels = [
            ...
            dataset_json_dict_or_file["labels"]["pancreatic_lesion"],
            dataset_json_dict_or_file["labels"]["pancreatic_lesion"],
            dataset_json_dict_or_file["labels"]["pancreatic_lesion"]
        ]
