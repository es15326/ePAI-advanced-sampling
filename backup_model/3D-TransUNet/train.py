...
def main():
    ...
    parser.add_argument("-c", "--continue_training", help="use this if you want to continue a training",
                        action="store_true")
    parser.add_argument("-ft", "--finetune", help="use this if you want to continue a training WITH DIFFERNE NUM CLASSES (not load class_emb and optimizer)",
                        action="store_true")
    ...
    # parser.add_argument("--local_rank", type=int) # must pass
    parser.add_argument(
    ...
    # 
    if 'Task005' in plans_file or 'Task004' in plans_file or 'Task002' in plans_file or 'Task001' in plans_file or 'Task1004' in plans_file:
        resolution_index = 0
    ...
    if find_lr:
        ...
        if not validation_only:
            if args.continue_training and args.finetune:
                # -c and -ft were set, continue a previous training and ignore pretrained weights
                trainer.load_latest_checkpoint(finetune=True)
