...
class nnUNetTrainerV2_DDP(nnUNetTrainerV2):
    ...
    def load_checkpoint_ram(self, checkpoint, train=True, finetune=False):
        """
        ...
        for k, value in checkpoint['state_dict'].items():
            key = k
            if finetune:
                # TODO: remove state containing class_embed for finetuning
        ...
        if train and not finetune:
            ...
            print('************ I am finetuning. Not loading optimizer and lr_scheduler, plot_stuff')
            self.print_to_log_file('************ I am finetuning. Not loading optimizer and lr_scheduler, plot_stuff')
