...
def main(args):
    ...
    plot_scaling_ood_result(auc, legend_exp_name=args.scaling_legend+' (n={})'.format(len(gt_results)),
...
if __name__ == "__main__":
    ...
    parser.add_argument('--csv_path', type=str, default='result/raw/scaling/scaling_seed4', help='Path to the CSV file containing results')
    ...
    parser.add_argument('--pct', type=str, default='10,25,50,75,100,200', help='Use of training set percentage')
